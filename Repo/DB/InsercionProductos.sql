...
UPDATE ImgProductos SET ProductoId = 1 WHERE ImgId = 1;

UPDATE ImgProductos SET ProductoId = 2 WHERE ImgId = 2;

UPDATE ImgProductos SET ProductoId = 3 WHERE ImgId = 3;
